...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "ObjectPullTargetAssistRadiusMeters", CfgOptionType::Float, "\xE6\xAD\xA6\xE5\x99\xA8 / \xE9\x9A\x94\xE7\xA9\xBA\xE6\x8A\x93\xE5\x8F\x96", "\xE7\x9E\x84\xE5\x87\x86\xE8\xBE\x85\xE5\x8A\xA9\xE5\x8D\x8A\xE5\xBE\x84 (\xE7\xB1\xB3)", 0.00f, 0.50f, "0.08" },
