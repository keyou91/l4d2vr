...
void VR::ParseConfigFile()
{
    ...
    {
        // The launch argument is the master switch.  Keep every Neko post
        // option inert so a config entry cannot activate part of this path.
        m_NekoEnginePostVRTakeover = false;
        m_NekoEnginePostVRCaptureBackBuffer = false;
        m_NekoEnginePostVRClearTarget = false;
        m_NekoEnginePostVRDisableNekoBloom = false;
        m_NekoEnginePostVRUseNativeFullFrameSource = false;
        m_NekoEnginePostVRHDRSceneInput = false;
        m_NekoEnginePostVRDecodeInputSrgb = false;
        m_NekoEnginePostVROutputGammaCorrection = false;
        m_NekoEnginePostProbeLog = false;
        m_NekoEnginePostProbeLogHz = 0.0f;
    }
